...
class PYRTControl(BaseControl):
    ...
    def __init__(self,
        ...
        if self.DRONE_MODEL != DroneModel.CF2X and self.DRONE_MODEL != DroneModel.CF2P:
            ...
            exit()
        self.P_COEFF_FOR = np.array([0.1, 0.01, -0.5])
        self.I_COEFF_FOR = np.array([0.1, 0.01, -0.5])
        self.D_COEFF_FOR = np.array([0.1, 0.006, 0.07]) #_   _   throttle
        self.P_COEFF_TOR = np.array([10, 10, 10.]) #roll   pitch   YAW
        self.I_COEFF_TOR = np.array([2, 2, 10])
        self.D_COEFF_TOR = np.array([10., 10., 0])
    ...
    def _dslPIDPositionControl(self,
        ...
        vel_e = target_vel - cur_vel - np.cross(cur_ang_vel, cur_pos)
    ...
    def _dslPIDAttitudeControl(self,
        ...
        rpy_rates_e = target_rpy_rates - (cur_rpy - self.last_rpy) / control_timestep - cur_ang_vel
