...
def run(
    ...
    for i in range(0, int(duration_sec*env.CTRL_FREQ)):
        ...
        for j in range(num_drones):
            print("TARGET_POS[wp_counters[j], 0:2] shapw = ",TARGET_POS[wp_counters[j], 0:2].shape, TARGET_POS[wp_counters[j], 0:2] )
            print("INIT_XYZS[j, 2] shape = ",INIT_XYZS[j, 2].shape, INIT_XYZS[j, 2])
